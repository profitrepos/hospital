...
const $viewPresets = {
  ...
  filled: [$baseViewStyle, { backgroundColor: "red" }] as StyleProp<ViewStyle>,

  reversed: [$baseViewStyle, { backgroundColor: "blue" }] as StyleProp<ViewStyle>,
}

const $textPresets: Record<Presets, StyleProp<TextStyle>> = {
  default: $baseTextStyle,
  filled: $baseTextStyle,
  reversed: [$baseTextStyle, { color: "black" }],
}

const $pressedViewPresets: Record<Presets, StyleProp<ViewStyle>> = {
  default: { backgroundColor: "black" },
  filled: { backgroundColor: "black" },
  reversed: { backgroundColor: "black" },
}
